...
//Clears the entire existing task before starting the new activity.
//So, when LoginActivity starts, it becomes the only activity in the task — all other activities are removed from the back stack.
// starts the LoginActivity as the root of a new, clean task.
