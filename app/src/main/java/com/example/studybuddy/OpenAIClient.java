...
//OpenAIClient wraps the logic to talk to OpenAI
public class OpenAIClient {
    //private static final String API_KEY="this is a fake api key for testing";
    private static final String API_URL = "https://api.openai.com/v1/chat/completions";
    //    public static final MediaType JSON = MediaType.get("application/json");

    OkHttpClient client; //OkHttp sends/receives HTTP requests
